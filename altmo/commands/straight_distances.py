...
@psycopg2_cur(PG_DSN)
def straight_distance(cursor, study_area, category, show_status):
    """
    ...
    add_amenity_residence_distances_straight(cursor, study_area_id, category=category, show_status=show_status)
